...
def search_by_title(title: str, wiki_posts: list[WikiPosts], amount: int) -> list[WikiPosts]:
    wiki_titles = [wiki.title for wiki in wiki_posts]
    matches = process.extract(title, wiki_titles, limit=amount,processor=utils.default_process)
